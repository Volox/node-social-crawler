...
Social.prototype.getByTag = function*( /* tag, options, status */ ) { throw new Error( 'Implement me!' ); };
Social.prototype.getByTags = function*( /* tags, options, status */ ) { throw new Error( 'Implement me!' ); };
Social.prototype.getByUser = function*( /* user, options, status */ ) { throw new Error( 'Implement me!' ); };
Social.prototype.getByUsers = function*( /* users, options, status */ ) { throw new Error( 'Implement me!' ); };
Social.prototype.getByGeoGrid = function*( /* gridData, options, status */ ) { throw new Error( 'Implement me!' ); };
